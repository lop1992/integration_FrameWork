...
public class BeanUtil {
	...
	public static String getClassPath(Object bean){
	...
	public static boolean getBoolean(Object bean, String param,
		...
		if (bean != null) {
			try {
				beanValue = (Boolean) PropertyUtils.getSimpleProperty(bean,
						param);
			} catch (Exception e) {
				log.error(e);
			}
	...
	public static double getDouble(Object bean, String param,
		...
		if (bean != null) {
			try {
				beanValue = (Double) PropertyUtils.getSimpleProperty(bean,
						param);
			} catch (Exception e) {
				log.error(e);
			}
	...
	public static int getInteger(Object bean, String param, int defaultValue) {
		...
		if (bean != null) {
			try {
				beanValue = (Integer) PropertyUtils.getSimpleProperty(bean,
						param);
			} catch (Exception e) {
				log.error(e);
			}
	...
	public static String getString(Object bean, String param,
		...
		if (bean != null) {
			try {
				beanValue = (String) PropertyUtils.getSimpleProperty(bean,
						param);
			} catch (Exception e) {
				log.error(e);
			}
